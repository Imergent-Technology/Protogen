...
APP_KEY=
APP_DEBUG=true
APP_URL=http://protogen.local:8080
...
MAIL_FROM_ADDRESS="hello@protogen.local"
...
echo "3. Access the application at: http://protogen.local:8080"
echo "4. Access the UI at: http://protogen.local:3000"
echo ""
